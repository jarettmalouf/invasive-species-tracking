...
location test_points[] =
  {
  // {12.0,8.0},{18.0,11.0},{15.0,15.0},{8.0,12.0},{3.0,18.0},{10.0,1.0} ,{17.0,5.0},
...
int main(int argc, char **argv)
{
  ...
  switch (test)
    ...
    case 9:
          // test_nearest(test_points, 7, &example_query);
